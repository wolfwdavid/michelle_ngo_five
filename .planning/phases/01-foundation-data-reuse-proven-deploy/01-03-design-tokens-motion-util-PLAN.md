...
<task type="auto">
  ...
  <read_first>
    ...
    - C:/Users/Mkaru/Documents/Hello_World/hugginface_profile/Websites/michelle_ngo_websites/michelle_ngo_four/src/lib/components/categoryAccent.test.ts
  </read_first>
  <action>
    ...
    3. Copy `src/lib/components/categoryAccent.test.ts` VERBATIM (asserts every Category maps to a defined text-cat-* literal).
